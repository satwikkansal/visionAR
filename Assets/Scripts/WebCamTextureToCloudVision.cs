...
public class WebCamTextureToCloudVision : MonoBehaviour {
	...
	public class AnnotateImageResponse {
		...
		public WebAnnotation webDetection;
	...
	public class WebAnnotation {
		...
		public List<VisuallySimilarImages> visuallySimilarURLList;
	}
	...
	public IEnumerator GoogleSearchAPI(){
		...
		string GOOGLE_SEARCH_URL = "https://radiant-taiga-23109.herokuapp.com/define_duck?q=";
